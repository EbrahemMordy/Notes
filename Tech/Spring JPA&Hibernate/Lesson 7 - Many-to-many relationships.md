...
---
- **One Way Relation**
- you add List of the other entity and add `ManyToMany` and also `JoinTable` with `joinColumns` and add column of current entity, then add `inverseJoinColumns` and add other entity keys
---
- **Two Way Relation**
