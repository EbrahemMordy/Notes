...
- add `GeneriecGenerator` annotation with name of the class we created and add type as it as class
- also use generator with same name we customized above
## Composed Primary Keys
when your ID is not only one column 
> When use composed, don't forget to override hash and equals in Classes of IDs to used when compared to add unique rows
...
this means you can have an instance of the key and embedded it in the entity directly
